...
function ensureDir(dir) {
    ...
    if (subs.length === 1) {
        ...
        var current = process.cwd() + subs[0];
...
function isJsIdentifier(identifier) {
    return jsIdentifierRegex.test(identifier);
}
exports.isJsIdentifier = isJsIdentifier;
function writeFailure(error) {
    if (error !== null) {
        console.error(error);
    }
}
function createComponent(componentName, componentPath, noView, noTypes) {
    ...
    var localDir = "/app/modules/" + componentPath;
    ensureDir(localDir);
...
function createModule(moduleName, noComp, noStyles) {
    var moduleDetails = templates_1.makeModuleFile(moduleName, noComp, noStyles);
    var localDir = "/app/modules/" + moduleName + "/";
    ensureDir(localDir);
    var basePath = process.cwd() + localDir;
    var moduleFilePath = basePath + "/" + moduleName + ".module.ts";
